...
var UIController = (function() {
    ...
    // Function for formatting how numbers appear on the UI
    var formatNumber = function (num,type) {
        ...
        // 2. commas separating the thousands
        numSplit = num.split('.');
        int = numSplit[0];
        decimal = numSplit[1];
        if(int.length >3){
    ...
    return {
        ...
        displayMonth : function (){
            ...
            month = now.getMonth();// Zero based function
            document.querySelector(DOMstrings.dateLabel).textContent = months[month] + ' '+ year;

        },
        // Function to toggle the input border colors
        changeType : function () {
